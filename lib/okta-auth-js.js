...
var OktaAuth = (function (e) {
  ...
  function (e, t, r) {
    ...
    function s(e, t) {
      var r = (t = t || {}).url,
        ...
        d = l.storage,
        p = l.getHttpCache(e.options.cookies);
      if (t.cacheResponse) {
        var h = p.getStorage()[r];
  ...
  function (e, t, r) {
    ...
    t.REDIRECT_OAUTH_PARAMS_COOKIE_NAME = "okta-oauth-redirect-params";
          ...
          case "POST":
            return function (i) {
              ...
              if (void 0 !== p) {
                ...
                else null !== p && (l.rememberDevice = !!p);
              ...
              var h = n.href + (0, a.toQueryParams)(l);
              return (0, f.postToTransaction)(e, h, c);
            };
        }
    }
    function d(e, t, r, n) {
    ...
    (t.generateState =
      ...
      (t.isLoginRedirect = function (e) {
        ...
        if (t.pkce || "code" === t.responseType || "query" === t.responseMode)
          return "fragment" === t.responseMode
            ? c(window.location.hash)
            : c(window.location.search);
        return (r = window.location.hash), /((id|access)_token=)/i.test(r);
        var r;
      }),
          ...
          return (function n() {
            return r.isPolling
              ? (function () {
                  ...
                  var n = g.href + (0, i.toQueryParams)(r);
                  ...
                  .then(function (t) {
                    if (
                      ...
                      return (
                        "function" == typeof h && h(t), (0, i.delay)(l).then(n)
                      );
                    }
  ...
  function (e, t, r) {
    ...
    var x = function (e, t, r, n) {
      ...
      R = (function (e) {
        ...
        function r(e) {
          ...
          (0, a.default)(this, r),
            (e = Object.assign(
              { httpRequestClient: h.default, storageUtil: g.default },
              e
            )),
            (n = t.call(this, e));
          var o = Object.assign({ secure: !0 }, e.cookies);
          n.features.isLocalhost() && !n.features.isHTTPS() && (o.secure = !1),
            void 0 === o.sameSite && (o.sameSite = o.secure ? "none" : "lax"),
            o.secure &&
              !n.features.isHTTPS() &&
              (console.warn(
            ...
            (n.session = {
              close: w.closeSession.bind(null, (0, u.default)(n)),
              exists: w.sessionExists.bind(null, (0, u.default)(n)),
              get: w.getSession.bind(null, (0, u.default)(n)),
              refresh: w.refreshSession.bind(null, (0, u.default)(n)),
              setCookieAndRedirect: w.setCookieAndRedirect.bind(
                null,
                (0, u.default)(n)
              ),
            }),
            (n._tokenQueue = new O.default()),
            (n.token = {
              getWithoutPrompt: b.getWithoutPrompt.bind(
                null,
                (0, u.default)(n)
              ),
              getWithPopup: b.getWithPopup.bind(null, (0, u.default)(n)),
              getWithRedirect: b.getWithRedirect.bind(null, (0, u.default)(n)),
              parseFromUrl: b.parseFromUrl.bind(null, (0, u.default)(n)),
              decode: b.decodeToken,
              revoke: b.revokeToken.bind(null, (0, u.default)(n)),
              renew: b.renewToken.bind(null, (0, u.default)(n)),
              getUserInfo: b.getUserInfo.bind(null, (0, u.default)(n)),
              verify: b.verifyToken.bind(null, (0, u.default)(n)),
              isLoginRedirect: k.isLoginRedirect.bind(null, (0, u.default)(n)),
            });
          var i = ["decode", "isLoginRedirect"];
          return (
            Object.keys(n.token).forEach(function (e) {
              if (!(i.indexOf(e) >= 0)) {
                var t = n.token[e];
                n.token[e] = O.default.prototype.push.bind(
                  n._tokenQueue,
                  t,
                  null
                );
            ...
            (n.fingerprint = _.default.bind(null, (0, u.default)(n))),
            (n.emitter = new P()),
            (n.tokenManager = new T.TokenManager(
              (0, u.default)(n),
              e.tokenManager
            )),
            n
        ...
        return (
          (0, s.default)(r, [
              ...
              value: function (e) {
                ...
                var r = function (r) {
                  return (
                    ...
                    (0, S.postToTransaction)(t, "/api/v1/authn", e, r)
                  );
                };
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              if (
                                ...
                                (o =
                                  ...
                                  r),
                                (a = e.accessToken),
                                (s = !1 !== e.revokeAccessToken),
                                (u = e.idToken),
                                (c = (0, k.getOAuthUrls)(this).logoutUrl),
                                void 0 !== u)
                              ) {
                                t.next = 12;
                                break;
                              ...
                              return (
                                (t.next = 11),
                                this.tokenManager.get(m.ID_TOKEN_STORAGE_KEY)
                              );
                            case 11:
                              u = t.sent;
                            case 12:
                            ...
                            case 15:
                              a = t.sent;
                            case 16:
                              if ((this.tokenManager.clear(), !s || !a)) {
                                t.next = 20;
                                break;
                              }
                              return (t.next = 20), this.revokeAccessToken(a);
                            case 20:
                              if (u) {
                                t.next = 22;
                                break;
                            ...
                            case 22:
                              (f = e.state),
                                ...
                                f && (d += "&state=" + encodeURIComponent(f)),
            ...
            },
            {
              key: "webfinger",
              value: function (e) {
                var t = "/.well-known/webfinger" + (0, v.toQueryParams)(e);
    ...
    R.features = R.prototype.features = p;
    var C = R;
    (t.default = C), (e.exports = t.default);
  },
  function (e, t, r) {
        ...
        (k.prototype = {
          ...
          finish: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
              ...
              if (r.finallyLoc === e)
                return this.complete(r.completion, r.afterLoc), T(r), c;
            }
          },
          catch: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
  ...
  function (e, t) {
    ...
    !(function (e) {
      !(function (t) {
        ...
        (E.polyfill = !0),
          e.fetch ||
            ((e.fetch = E), (e.Headers = d), (e.Request = w), (e.Response = T)),
          (t.Headers = d),
          (t.Request = w),
          (t.Response = T),
          (t.fetch = E);
        ...
        function n(t, o, i) {
          ...
          if ("undefined" != typeof document) {
            ...
            for (
              ...
              try {
                var g = p[0].replace(l, decodeURIComponent);
                if (
                  ((h = r.read
                    ? r.read(h, g)
                    : r(h, g) || h.replace(l, decodeURIComponent)),
                  this.json)
                )
                  try {
                    h = JSON.parse(h);
  ...
  function (e, t, r) {
    ...
    (t.revokeToken = function (e, t) {
      ...
      (t.getWithRedirect = function (e, t) {
        ...
        return (
          (t = (0, s.clone)(t) || {}),
          S(e, t).then(function (r) {
            var n = (0, u.getOAuthUrls)(e, t),
              o = n.authorizeUrl + E(r),
              i = r.responseType,
              a = r.state,
              s = r.nonce,
              c = r.scopes,
              ...
              l = r.ignoreSignature;
            y.set(
              d.REDIRECT_OAUTH_PARAMS_COOKIE_NAME,
              JSON.stringify({
                responseType: i,
                state: a,
                nonce: s,
              ...
              y.set(
                d.REDIRECT_NONCE_COOKIE_NAME,
                r.nonce,
                null,
                e.options.cookies
              ),
              y.set(
                d.REDIRECT_STATE_COOKIE_NAME,
                r.state,
                null,
                e.options.cookies
              ),
      ...
      (t.parseFromUrl = function (e, t) {
        ...
        if (!r)
          return Promise.reject(
            new f.default("Unable to parse a token from the url")
          );
        var c = y.get(d.REDIRECT_OAUTH_PARAMS_COOKIE_NAME);
        if (!c)
          return Promise.reject(
            new f.default("Unable to retrieve OAuth redirect params cookie")
          );
        try {
          var l = JSON.parse(c),
            p = l.urls;
          delete l.urls, y.delete(d.REDIRECT_OAUTH_PARAMS_COOKIE_NAME);
        } catch (e) {
          return Promise.reject(
            new f.default(
              "Unable to parse the " +
        ...
        return Promise.resolve((0, u.urlParamsToObject)(r)).then(function (t) {
          return (
            o ||
              ("query" === i
                ? (function (e) {
      ...
      (t.renewToken = function (e, t) {
        ...
        return _(e, {
          ...
          var r = e.tokens;
          return (0, g.isIDToken)(t) ? r.idToken : r.accessToken;
        });
      }),
              ...
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    ...
                    return (
                      (n.next = 3),
                      e.tokenManager.get(d.ACCESS_TOKEN_STORAGE_KEY)
                    );
                  case 3:
                    t = n.sent;
                  case 4:
                    ...
                    return (
                      (n.next = 7), e.tokenManager.get(d.ID_TOKEN_STORAGE_KEY)
                    );
                  case 7:
                    r = n.sent;
                  case 8:
                    if (
                      t &&
                      ((0, g.isToken)(t) || t.accessToken || t.userinfoUrl)
                    ) {
                      n.next = 10;
                      break;
                    }
                  ...
                  case 10:
                    ...
                    return n.abrupt(
                      "return",
                      Promise.reject(
                        new f.default("getUserInfo requires an ID token object")
                      )
                    );
                  case 12:
                    return n.abrupt(
                      ...
                      a.default
                        ...
                        .catch(function (e) {
                          ...
                          if (
                            ...
                            (e.xhr.headers &&
                            (0, s.isFunction)(e.xhr.headers.get) &&
                            e.xhr.headers.get("WWW-Authenticate")
                              ? (t = e.xhr.headers.get("WWW-Authenticate"))
                              : (0, s.isFunction)(e.xhr.getResponseHeader) &&
      ...
      (t.verifyToken = w),
      (t.handleOAuthResponse = k),
      (t.prepareTokenParams = S);
    var i = o(r(19)),
      a = o(r(4)),
      s = r(2),
      u = r(17),
    ...
    function m(e) {
      ...
      try {
        t = {
          header: JSON.parse((0, s.base64UrlToString)(r[0])),
          payload: JSON.parse((0, s.base64UrlToString)(r[1])),
          signature: r[2],
        };
      } catch (e) {
        throw new f.default("Malformed token");
      }
      return t;
    }
    function w(e, t, r) {
      return Promise.resolve().then(function () {
        if (!t || !t.idToken)
          throw new f.default("Only idTokens may be verified");
        var n = m(t.idToken),
          o = {
        ...
        return (
          Object.assign(o, r),
          (0, u.validateClaims)(e, n.payload, o),
          1 != o.ignoreSignature && e.features.isTokenVerifySupported()
            ? (0, u.getKey)(e, t.issuer, n.header.kid)
                .then(function (e) {
                  return c.verifyToken(t.idToken, e);
                })
                .then(function (e) {
                  if (!e)
                    throw new f.default("The token signature is not valid");
                  if (r && r.accessToken && t.claims.at_hash)
                    return c.getOidcHash(r.accessToken).then(function (e) {
                      if (e !== t.claims.at_hash)
                        throw new f.default("Token hash verification failed");
                    });
                })
                .then(function () {
                  return t;
    ...
    function b(e, t, r) {
      ...
      return new Promise(function (i, a) {
        (n = function (t) {
          ...
          (0, u.addListener)(window, "message", n),
          (o = setTimeout(function () {
            a(new f.default("OAuth flow timed out"));
          }, t || 12e4));
      }).finally(function () {
        clearTimeout(o), (0, u.removeListener)(window, "message", n);
      });
    }
    function T(e, t) {
      if (e.error || e.error_description)
        throw new l.default(e.error, e.error_description);
      if (e.state !== t.state)
        throw new f.default(
      ...
      return Promise.resolve()
        ...
        .then(function (r) {
          ...
          if (
            ...
            var l = e.token.decode(f),
              d = {
                value: f,
                idToken: f,
                claims: l.payload,
                expiresAt: l.payload.exp,
                scopes: i,
                authorizeUrl: n.authorizeUrl,
                issuer: n.issuer,
                clientId: a,
            ...
            return (
              ...
              w(e, d, p).then(function () {
                return (o.idToken = d), o;
              })
            );
          }
          return o;
        ...
        : S(e, (t = t || {}))
            .then(function (r) {
              ...
              switch (
                ...
                (o = (0, u.getOAuthUrls)(e, r)),
                (n = (t.codeVerifier ? o.tokenUrl : o.authorizeUrl) + E(r)),
                ...
                case "POPUP":
                  ...
                  if ("okta_post_message" === r.responseMode) {
                    ...
                    s = b(e, t.timeout, r.state);
                  }
                  var c = { popupTitle: t.popupTitle },
                    l = (0, u.loadPopup)(n, c);
                  return new Promise(function (e, t) {
                    var r = setInterval(function () {
                      (l && !l.closed) ||
                        (clearInterval(r),
                        t(
                          new f.default("Unable to parse OAuth flow response")
                        ));
                    }, 100);
                    s.then(function (t) {
                      clearInterval(r), e(t);
            ...
            .catch(function (t) {
              throw (e.options.pkce && h.default.clearMeta(e), t);
            });
    }
    function _(e, t) {
      return arguments.length > 2
    ...
    function S(e, t) {
      ...
      var r = (function (e) {
        return {
          ...
          state: (0, u.generateState)(),
          nonce: (0, u.generateNonce)(),
          scopes: ["openid", "email"],
          ignoreSignature: e.options.ignoreSignature,
        };
      })(e);
      ...
      if (!e.features.isPKCESupported()) {
        ...
        return (
          ...
          Promise.reject(new f.default(n))
        );
      }
      return (
        r.codeChallengeMethod ||
          (r.codeChallengeMethod = h.default.DEFAULT_CODE_CHALLENGE_METHOD),
        (r.responseType = "code"),
        (0, u.getWellKnown)(e, null)
          .then(function (e) {
            if (
              -1 ===
              ...
              throw new f.default("Invalid code_challenge_method");
          })
          .then(function () {
            var t = h.default.generateVerifier(r.codeVerifier),
              n = { codeVerifier: t, redirectUri: r.redirectUri };
            return h.default.saveMeta(e, n), h.default.computeChallenge(t);
          })
          .then(function (e) {
            var t = (0, s.clone)(r) || {};
    ...
    var f = {
      ...
      getToken: function (e, t, r) {
        ...
        var n = (function (e) {
          ...
          return (0, a.toQueryParams)(t).slice(1);
        })(t);
        return i.default.httpRequest(e, {
          url: r.tokenUrl,
          method: "POST",
  ...
  function (e, t, r) {
    ...
    (t.isToken =
       ...
       */
      function (e) {
        if (e && (e.accessToken || e.idToken) && Array.isArray(e.scopes))
          return !0;
        return !1;
      }),
  ...
  function (e, t, r) {
    ...
    var o = n(r(9)),
      ...
      l = n(r(55)),
      d = r(29),
      p = { autoRenew: !0, storage: "localStorage", expireEarlySeconds: 30 };
    function h(e, t) {
      return t.expiresAt - e.options.expireEarlySeconds;
    }
    function g(e, t) {
      return h(e, t) <= e.clock.now();
    }
    function v(e, t) {
    ...
    function w(e, t, r, n, o) {
      ...
      if (
        !(0, a.isObject)(o) ||
        !o.scopes ||
        (!o.expiresAt && 0 !== o.expiresAt) ||
        (!(0, d.isIDToken)(o) && !(0, d.isAccessToken)(o))
      )
        throw new s.default(
          "Token must be an Object with scopes, expiresAt, and an idToken or accessToken properties"
        );
      (i[n] = o), r.setStorage(i), m(0, t, n, o);
    }
    function b(e, t) {
      ...
      return (
        ...
        (t.renewPromise[n] = e.token
          ...
          .then(function (e) {
            var o = b(r, n);
            if (o)
              return w(0, t, r, n, e), t.emitter.emit("renewed", n, e, o), e;
          })
          .catch(function (e) {
            throw (
              (("OAuthError" !== e.name && "AuthSdkError" !== e.name) ||
                (k(t, r, n),
                (e.tokenKey = n),
    ...
    function O(e, t) {
      !(function (e) {
        ...
        for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && y(e, r);
      })(e),
        t.clearStorage();
    }
    t.TokenManager = function e(t, r) {
      ...
      if (
        ...
        switch (r.storage) {
          ...
          case "cookie":
            n = (function (e) {
              var t = u.default.getCookieStorage(e);
              return {
                getItem: function (e) {
                  var r = t.getItem(),
                    n = {};
                ...
                setItem: function (e, r) {
                  ...
                  (r = JSON.parse(r)),
                    ...
                    Object.keys(n).forEach(function (t) {
                      u.default.storage.delete(e + "_" + t);
                    });
                },
              };
            })(t.options.cookies);
            break;
          case "memory":
            n = u.default.getInMemoryStorage();
            break;
          default:
            throw new s.default("Unrecognized storage option");
        }
      var h = r.storageKey || c.TOKEN_STORAGE_NAME,
        y = (0, f.default)(n, h),
        b = {
          clock: l.default.create(),
          options: r,
          emitter: t.emitter,
          expireTimeouts: {},
          renewPromise: {},
        };
      (this.add = w.bind(this, t, b, y)),
        (this.get = T.bind(this, t, b, y)),
        (this.remove = k.bind(this, b, y)),
        (this.clear = O.bind(this, b, y)),
        (this.renew = E.bind(this, t, b, y)),
        (this.on = b.emitter.on.bind(b.emitter)),
        (this.off = b.emitter.off.bind(b.emitter)),
        (this.hasExpired = g.bind(this, b));
      this.on("expired", function (e) {
        r.autoRenew ? d.renew(e).catch(function () {}) : d.remove(e);
      }),
        (function (e, t, r) {
          try {
            var n = r.getStorage();
          ...
          for (var o in n) {
            if (Object.prototype.hasOwnProperty.call(n, o)) m(0, t, o, n[o]);
          }
        })(0, b, y);
    };
  },
